...
async function handleFormSubmit(e) {
    ...
    // Otomatis tandai profile telah diupdate/diverifikasi mandiri
...
async function editPegawai(nik) {
    ...
    // Isi setiap input form berdasarkan atribut name
    ...
    // Kunci field NIK saat edit mode agar primary key aman
...
function resetForm() {
    ...
    // Reset tab active ke tab pertama
    ...
    fileInput?.addEventListener('change', function() {
        ...
        reader.onload = async (e) => {
            try {
                ...
                // Insert massal data mentah ke Supabase
...
// Daftarkan fungsi aksi baris tabel ke scope global window
